...
\usepackage[style=apa, backend=biber,style=numeric, natbib=true, sortlocale=de_DE]{biblatex}
\usepackage{subcaption}
%\usepackage{apacite}		% Zitierstil
%\usepackage[numbers]{natbib} 		% Erweiterte zitiermöglichkeiten 
